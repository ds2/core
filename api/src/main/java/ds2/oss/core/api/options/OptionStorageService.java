...
/**
 * A service to store and retrieve options and option values from various
 * sources.
 *
 * @author dstrauss
 * @version 0.3
 * @param <E> the type of the primary key
 */
public interface OptionStorageService<E> {
     ...
     * @throws OptionException if a technical error occurred
     */
     ...
     *
     * @param optionIdent the option identifier
     * @param ctx the option value context
     * @param scheduleDate the schedule date for this value
     * @param value the value of the option value
     * @param <V> the value type
     * @return the created option value
     * @throws CreateOptionValueException if an error occurred
     */
     ...
     * @param val the value for the option. If the option is encrypted, this
     * value must be the original value. Implementations must encrypt this value
     * before persisting.
     * @param <V> the value type
     * @return the created option
     * @throws CreateOptionException if creation failed for some reason
     */
     ...
     * @param ctx the option value context
     * @param <V> the value type
     * @return the option value to use. This MAY return a virtual option value
     * with the option.
     */
     ...
     *
     * @param endpoint the option identifier
     * @param <V> the value type of the option identifier
     * @param deleted the new stage
